...
\question[4]
\textbf{Bereken} het maximum van $P_3'(x)$, uitgedrukt als factor van het oorspronkelijke vermogen $P = P_3'(1) = \dfrac{4U_b^2}{9R}$ uit opgave~1.

\begin{solution}
\begin{itemize}
  \item Bij het maximum is $x^2 = \tfrac{3}{2}$, dus $x^3 = \left(\tfrac{3}{2}\right)^{3/2} = \tfrac{3}{4}\sqrt{6}$ en $(2x^2+1)^2 = 4^2 = 16$.
  \item Invullen in $P_3'(x) = \dfrac{4x^3\,U_b^2}{R\,(2x^2+1)^2}$ levert het maximum:
    \[P_3'(x_{max}) = \dfrac{4 \cdot \tfrac{3}{4}\sqrt{6} \cdot U_b^2}{16\,R} = \dfrac{3\sqrt{6}}{16}\cdot \dfrac{U_b^2}{R}.\]
  \item Uitdrukken als factor van $P = \dfrac{4U_b^2}{9R}$:
    \[\dfrac{P_3'(x_{max})}{P} = \dfrac{3\sqrt{6}/16}{4/9} = \dfrac{27\sqrt{6}}{64} \approx 1{,}034.\]
  \item Het maximum ligt dus slechts ongeveer $3{,}4\,\%$ boven het oorspronkelijke vermogen --- bij $x=1$ zit de schakeling al dicht bij het maximum, ook al varieert $P_3'(x)$ over een groot bereik van $x$ aanzienlijk.
\end{itemize}
\end{solution}
