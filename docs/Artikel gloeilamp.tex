...
Het model is overgenomen van Arno Rijnders, uit zijn opmerking op Facebook. Echter de startwaarden zijn aangepast zodat de hete limiet bereikt wordt. De temperatuurcoëfficiënt is afhankelijk van de temperatuur, in het model is de constante waarde daarom iets naar boven verschoven, zodat de modelregels hetzelfde konden blijven.
...
dezelfde eindtoestand uitkomen. Dat $U_3$ in alle drie de gevallen rond
$\qty{13.8}{\V}$ uitkomt, ruim boven de $\qty{12}{\V}$ van het nominale
werkpunt, maakt het examenantwoord onomstotelijk: lamp~3 brandt op een te
hoog vermogen.
